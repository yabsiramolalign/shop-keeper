                                ...
                                child: Row(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              controller.summaries[index].date,
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold),
                                            ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              controller.summaries[index].total
                                                  .toStringAsFixed(2),
                                              style: TextStyle(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              controller.summaries[index].income
                                                  .toStringAsFixed(2),
                                              style: TextStyle(
                                                  color: Colors.green),
                                            ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              controller.summaries[index].depth
                                                  .toStringAsFixed(2),
                                              style: TextStyle(
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Image(
                                        image:
                                            AssetImage('assets/cardback.png'),
                                        width: 70,
                                        height: 70,
                                      ),
                                    )
