...
//     List<Summary> last7Days =
//         summaryController.summaries.reversed.take(7).toList();
...
//           getTooltipColor: (tooltipItem) => Colors.transparent,
...
//   @override
//   Widget build(BuildContext context) {
//     return AspectRatio(aspectRatio: 1.6, child: _BarChart());
//   }
// }
